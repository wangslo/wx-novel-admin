<template>
    <div class="stack-room-page">
        ...
        <div class="stack-room-body">
            <el-form ref="stackRoomForm" :model="recommend_book_list_condition" :rules="stack_room_rules" class="stack-room-form"
            ...
            <div class="dialog-div">
                ...
                <el-dialog title="" :visible.sync="detailDialog" width="500px" center>
