<template>
  <div class="banner-app-page">
    ...
    <div class="banner-app-body">
      <el-form ref="bannerAppForm" :model="banner_app_condition" class="banner-app-form" label-width="80px" size="small">
        <el-form-item label="状态" label-width="60px">
          <el-select v-model="banner_app_condition.status" placeholder="请选择状态">
        ...
        <el-form-item label="位置" label-width="60px">
          <el-select v-model="banner_app_condition.position" placeholder="请选择位置">
            <el-option label="全部" value="999"></el-option>
          ...
          <el-col :span="10" class="startTime">
            <el-form-item  prop="create_start_time">
              <el-date-picker
                ...
                format="yyyy-MM-dd"
                placeholder="起始时间"
                v-model="banner_app_condition.create_start_time"
          ...
          <el-col :span="10" class="endTime">
            <el-form-item prop="create_end_time">
              <el-date-picker
                ...
                format="yyyy-MM-dd"
                placeholder="结束时间"
                v-model="banner_app_condition.create_end_time"
          ...
          <el-col :span="10" class="startTime">
            <el-form-item  prop="show_start_time">
              <el-date-picker
                ...
                format="yyyy-MM-dd"
                placeholder="起始时间"
                v-model="banner_app_condition.show_start_time"
          ...
          <el-col :span="10" class="endTime">
            <el-form-item prop="show_end_time">
              <el-date-picker
                ...
                format="yyyy-MM-dd"
                placeholder="结束时间"
                v-model="banner_app_condition.show_end_time"
        ...
        <el-form-item label="banner名称" label-width="100px">
          <el-input v-model="banner_app_condition.bannerName"></el-input>
        </el-form-item>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        ...
        pickerBeginDateBefore:{
          disabledDate: (time) => {
            let beginDateVal = this.banner_app_condition.create_end_time;
            if (beginDateVal) {
        ...
        pickerBeginDateAfter:{
          disabledDate: (time) => {
            let beginDateVal = this.banner_app_condition.create_start_time;
            if (beginDateVal) {
              return time.getTime() < beginDateVal;
            }
          }
        ...
        showPickerBeginDateBefore:{
          disabledDate: (time) => {
            let beginDateVal = this.banner_app_condition.show_end_time;
            if (beginDateVal) {
              return time.getTime() > beginDateVal;
            }
          }
        ...
        showPickerBeginDateAfter:{
          disabledDate: (time) => {
            let beginDateVal = this.banner_app_condition.show_start_time;
            if (beginDateVal) {
              return time.getTime() < beginDateVal;
            }
          }
    ...
    methods: {
      ...
      clearData() {
        this.$refs.bannerAppForm.resetFields()
        this.banner_app_condition.status = '999'
        this.banner_app_condition.bannerName = ''
        this.banner_app_condition.position = '999'
      },
