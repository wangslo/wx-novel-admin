  ...
  <div class="banner-wx-page">
    ...
    <div class="banner-wx-body">
      ...
      <el-table :data="tableData" style="width:100%;" stripe border>
        ...
        <el-table-column prop="showTime" label="展示时间" min-width="80" align="center"></el-table-column>
        ...
        <el-table-column label="操作" min-width="150" align="center">
          <template slot-scope="scope">
            <el-button size="mini" :disabled="scope.row.status == 0 ? true:false" type="danger"
                       @click="handleOffLine(scope.$index, scope.row)">下线
            </el-button>
            <el-button size="mini" v-show="scope.row.status != 1 ? true:false" type="primary"
                       @click="handleOnLine(scope.$index, scope.row)">上线
            </el-button>
            <el-button size="mini" v-show="false" type="warning" @click="handleEdit(scope.$index, scope.row)">编辑
            </el-button>
        ...
        tableData: [
          {
            ...
            "position": "男频",
            "bookName": "鬼吹灯",
            "showTime": "2019-05-07 ~ 2019-09-15",
